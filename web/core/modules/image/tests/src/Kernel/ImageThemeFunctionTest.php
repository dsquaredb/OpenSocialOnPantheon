...
class ImageThemeFunctionTest extends KernelTestBase {
   ...
   * @var array
   */
<<<<<<< HEAD:web/core/modules/image/src/Tests/ImageThemeFunctionTest.php
<<<<<<< HEAD
...
>>>>>>> updating open social:web/core/modules/image/tests/src/Kernel/ImageThemeFunctionTest.php
